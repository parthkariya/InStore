...
import { ACCEPT_HEADER, get_producttilesbanner, get_region_mall } from '../../utils/Constant'
            ...
            {loading === true ? (
                ...
                <div className="mm_main_wrapp">
                    <div className="leaderboard-sub-wrapp">
                        <RetailerNavigationBar title="Account Management" setTabType={getTab == 6 ? "Product Tiles" : ""} />
                        {/* LeaderBoard name start */}
                        <div className="mall_name_wrapp mall_name_wrapp-spacebetween" style={{ marginTop: "0px" }}>
                            <div className="leaderboard-inner-namebox">
                                <p className="mall_name_heading">{mainName}:</p>
                                <span className="leaderboard-span">Product Tiles</span>
                            </div>
                            <button className='leaderboard-btn' onClick={() => setTab(23)}>Add new <img src={images.add_new} className="leaderboard-btn-icon" /></button>
                        </div>
