...
import { AddLeaderBoardCard, AddProductTilesBannerCard, AddPromotionBannerCard } from '../../components';
...
const AddProductTilesBanner = ({ get_mall_auth_data, setTab }) => {
    ...
    return (
        <div className="mm_main_wrapp">
            ...
            <AddProductTilesBannerCard openMallModal={openMallModal} setTab={setTab} gatweek={gatweek}
                setWeek={setWeek}
