...
const AddPromotionBannerCard = ({ openMallModal, setTab, gateweek, seteweek, peopleInfo,
    ...
    regionidarray,
    selectedMalls, }) => {
    const { CreatePromotionBoardApi, category_data, multiple_week_data, getRetailerApi } = useStoreContext();
    const { get_brand_data, get_mall_data, getBrand } = useMallContext();
            ...
            />
                ...
                <div className="leaderboard-card-part-third">
                    ...
                    <div className="leaderboard-btn-box">
                        <button className="btn btn-orange" onClick={() => CreatePromotionBanner()}>Publish</button>
                    </div>
                </div>
